      ...
      <div className="row" id="team-page">
        ...
        <TeamHeader teamName={this.state.teamName} activeUser={this.props.activeUser} teamChange={this.props.teamChange}/>
            ...
            {this.state.groupConvos.length > 0 ? (
                this.state.groupConvos.map(convo => <TeamListItem key={convo._id} openConversation={this.openConversation} activeConvoId={this.state.activeConvo} {...convo} />
                )
            ...
            {this.state.memberConvos.length > 0 ? (
              this.state.memberConvos.map(convo => (
                <TeamListItem key={convo._id} openConversation={this.openConversation} activeConvoId={this.state.activeConvo} {...convo} />
              ))
            ) : (
